...
//arcecar ==> bukan
//menukar index 0 dan 1
//racecar ==> cek apakah dia palindrom atau bukan
//return true

console.log(palindromeSwapper('racecar')); // TRUE
console.log(palindromeSwapper('recacar')); // FALSE

//recacar ==> bukan palindrom
//menukar index 0 dan 1
//ercacar ==> cek, palindrom atau bukan? bukan
//menukar index 1 dan 2 dari kata yang asli === str
//rceacar ==> cek, palind
